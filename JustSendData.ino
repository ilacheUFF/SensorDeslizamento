//=======================================================================================//
/*  Modificado por Ivanovich 29/12/22.  
 *   
 * Envia de forma contiua para o id 3 o sinal para enviar de volta as informações do radio   
 */
...
#define SENHA_REDE "xxxxx" /* coloque aqui a senha da rede que se deseja conectar */
...
const unsigned long timeGetInfo = 330000;
...
const int nRadios=3;
int listaEndDevices[nRadios] = {3,3,3};//pode aumentar o tamanho do arry e incluir um novo ID. coloquei 1,2,1,2,1 ... porque no teste só temos os IDs 1 e 2 ... em uma rede maior ... deve-se cololcar os IDs existentes 1,2,3,50,517, 714,... qualquer inteiro de 1 até 1023.
